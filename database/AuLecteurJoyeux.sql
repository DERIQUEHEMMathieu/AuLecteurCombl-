DROP DATABASE IF EXISTS aulecteurjoyeux;
CREATE DATABASE aulecteurjoyeux CHARACTER SET 'utf8';
USE aulecteurjoyeux;

DROP USER IF EXISTS 'Admin'@'Localhost';
CREATE USER 'Admin'@'Localhost';
GRANT ALL PRIVILEGES ON aulecteurjoyeux.* TO 'Admin'@'Localhost' IDENTIFIED BY 'admin';
